...
class ClashRoyaleClans(commands.Cog):
    ...
    async def command_legend(
        ...
        async with ctx.channel.typing():
            ...
            embed.set_author(
                name="Vantage Family Clans",
                url="http://royaleapi.com/clan/family/vantage",
            ...
            if member is not None:
                return await ctx.send(
                    (
                        ...
                        "**Max Challenge Wins:** {}\n"
                        "**Clan:** {}\n\n"
                        ":warning: **NOTIFY Vantage Leadership "
        ...
        if is_clan_member:
            ...
            try:
                await simple_embed(
                    ...
                    "We have unlocked all the member channels for you in Vantage Discord Server. "
