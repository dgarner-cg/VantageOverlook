...
class LegendMenu():
    ...
    "main": {
        "embed": welcome.embed(title="Welcome", color=discord.Color.orange(),
                       description="Welcome to the **Vantage Clash Royale** Server, {0.mention}! "
    ...
    "join_clan": {
        "embed": welcome.embed(title="Vantage Family Clans", color=discord.Color.orange(),
    ...
    "end_guest": {
        "embed": welcome.embed(title="Enjoy your stay", color=discord.Color.orange(),
                       description="Welcome to the **Vantage Family** Discord server. "
    ...
    "other_game": {
        "embed": welcome.embed(title="Any other game?", color=discord.Color.orange(),
    ...
    "brawl_stars": {
        "embed": welcome.embed(title="Legend Brawl Stars", color=discord.Color.orange(),
